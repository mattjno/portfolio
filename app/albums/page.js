  ...
  return (
    <section className="albums-grid">
      ...
      <style jsx>{`
        ...
        .skeleton-title { height: 10px; width: 60%; margin: 14px auto 0; border-radius: 2px; background: linear-gradient(90deg, #111 25%, #1a1a1a 50%, #111 75%); background-size: 800px 100%; animation: shimmer 1.4s infinite linear; }
